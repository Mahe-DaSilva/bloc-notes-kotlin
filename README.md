...
Au démarrage, le menu est affiché directement par un appel de la fonction "blocNotes" depuis la fonction "main" les instructions sont ensuite données par l'utilisateur
...
### Structure du code
Le code est composé de façon très simple avec un menu qui permet d'appeler toutes les fonctions servant à réaliser les actions demandées par l'utilisateur.
Une fonction de standardisation des noms a été ajoutée, elle limite légèrement la liberté de création de noms pour les notes mais facilite grandement leur gestion dans l'interface textuelle.
